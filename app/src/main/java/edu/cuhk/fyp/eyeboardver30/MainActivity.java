package edu.cuhk.fyp.eyeboardver30;
...
import edu.cuhk.fyp.eyeboardver30.adapter.DeviceAdapter;
        ...
        switch (v.getId()) {
            case R.id.bt_command:
                if (bt_command.getText().equals(getString(R.string.start_scan))) {
                    ...
                    msg_box.setText(R.string.instr_calib);
                    bt_command.setVisibility(View.GONE);
                    bt_disconnect.setVisibility(View.GONE);
                    device_list.setVisibility(View.GONE);

                    //play instruction sound track
                    recording = MediaPlayer.create(this, R.raw.calib_recording);
                    recording.start();
                    recording.setOnCompletionListener(new MediaPlayer.OnCompletionListener(){
                        @Override
